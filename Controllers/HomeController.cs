    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult EnviarSenha(string Email)
        {
            try{
                ...
                //https://gemcbb.azurewebsites.net/home/RecuperarSenha/XXXXXXXXXXX
                        ...
                        <table c width='100%' style='border: solid 1px #189999;'>
                            ...
                            <tr>
                                <td style='padding: 10px;'>
                                    ...
                                    <br /><br />
                                    <a href='https://gemcbb.azurewebsites.net/home/RecuperarSenha/{0}' style='background-color: #495057; color:#fff;padding: 5px;border-radius: 5px;' hre='#'>https://gemcbb.azurewebsites.net/home/RecuperarSenha/{0}</a> 
                                    <br /><br />
                                </td>
                            </tr>
                        </table>        
