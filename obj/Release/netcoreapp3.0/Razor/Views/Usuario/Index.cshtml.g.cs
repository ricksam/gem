#pragma checksum "D:\PROJECTS\RckSoftware\CCB\gem\Views\Usuario\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1951f8f1efebfad48a448976a5bf5d76a6504585"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1951f8f1efebfad48a448976a5bf5d76a6504585", @"/Views/Usuario/Index.cshtml")]
...
#nullable disable
        ...
        function Edita(item) {
            ...
            rsp.get(item, ""/Usuario/Edit/"", (res) => {
                ...
                ComboGrupo(Co");
                WriteLiteral(@"d_Comum, item.Cod_Grupos);
            });
        }
        ...
        function DesejaRemover(id, nome) {
           ...
           ");
                WriteLiteral(@" $(""#RemoverUsuario"").html(nome);
        ...
        function EnviarConvite(Email) {
            ...
            rsp.post({ Email }, ""/Home/EnviarConvite"", (res) => {
                if (res == ""ok"") {
                    ...
                    $(""#mod");
                WriteLiteral(@"alEdit .alert"").show();
                    $(""#btn_convite"").hide();
                } else {
