#pragma checksum "D:\PROJECTS\RckSoftware\CCB\gem\Views\Usuario\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "de6ced3e688e36edc516b0cd2b64161f757d2ba5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"de6ced3e688e36edc516b0cd2b64161f757d2ba5", @"/Views/Usuario/Index.cshtml")]
        ...
        function Lista() {
            rsp.get(null, ""/Usuario/List?Cod_Comum="" + Cod_Comum, (res) => {
                ...
                $(""#ListaUsuarios .table"").DataTable({
                    ...
                    //],
                    ""language"": {
                        ""url"": ""//cdn.datatables.net/plug-ins/1.10.19/i18n/Portuguese-Brasil");
                WriteLiteral(@".json""
                    }
                });
                setTimeout(()=>{
        ...
        function Grava() {
            rsp.post(""#EditaUsuario"", ""/Usuario/Save"", (res) => {
                if (res == ""ok"") {
                    ...
                    Lista();
                    showAlert");
                WriteLiteral(@"(""Usuario gravado(a) com sucesso!"", ""alert-success"");
                } else {
