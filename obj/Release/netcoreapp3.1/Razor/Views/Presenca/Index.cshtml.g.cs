#pragma checksum "D:\PROJECTS\RckSoftware\CCB\gem\Views\Presenca\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e7298b216eef6888114cf725e91d44c0aa691108"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e7298b216eef6888114cf725e91d44c0aa691108", @"/Views/Presenca/Index.cshtml")]
...
#nullable disable
            ...
            BeginWriteAttribute("value", " value=\'", 1278, "\'", 1351, 1);
#nullable restore
#line 33 "D:\PROJECTS\RckSoftware\CCB\gem\Views\Presenca\Index.cshtml"
WriteAttributeValue("", 1286, GEM.Helpers.Util.BrazilianDatetimeNow().ToString("yyyy-MM-dd"), 1286, 65, false);
 ...
 ");
     ...
     ");
        ...
        function Aula(Cod_Presenca, Cod_Usuario) {
            rsp.pos");
                WriteLiteral(@"t({ Cod_Presenca, Cod_Usuario, Data }, ""/Presenca/Aula"", (res) => {
                $(""#Aula"").html(res);
        ...
        function GravarAulaGrupo() {
            ...
            rsp.post(""#DadosAulaGrupo"", ""/Presenca/GravarAulaGrupo"", (res) => {
                if (res == ""ok"") {
                    ...
                    //Lista();
   ");
                WriteLiteral(@"                 showAlert(""Aula gravada com sucesso!"", ""alert-success"");
                } else {
