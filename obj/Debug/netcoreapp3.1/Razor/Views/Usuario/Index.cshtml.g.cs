#pragma checksum "/home/ricksam/Projects/CCB/gem/Views/Usuario/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8b80381aed00ccd52b115ac516c388c46c651a2f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8b80381aed00ccd52b115ac516c388c46c651a2f", @"/Views/Usuario/Index.cshtml")]
...
#nullable restore
#line 17 "/home/ricksam/Projects/CCB/gem/Views/Usuario/Index.cshtml"
...
#nullable disable
            WriteLiteral("\n        </div>  \n    </div>\n");
#nullable restore
#line 26 "/home/ricksam/Projects/CCB/gem/Views/Usuario/Index.cshtml"
}
    ...
    <div class=""modal-dialog modal-lg"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-footer"">
                ...
                <button type=""button"" class=""btn btn-primary"" onclick=""Grava()"">Gravar</but");
            WriteLiteral(@"ton>
            </div>
        </div>
    </div>
...
<div class=""modal fade"" id=""modalDelete"" tabindex=""-1"" role=""dialog"" aria-hidden=""true""  data-backdrop=""static"">
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-footer"">
                <button type=""button"" class=""btn btn-secondary"" data-dismiss=""modal""> Fechar</button>
                <button type=""button"" class=""btn btn-danger"" onclick=""Re");
            WriteLiteral("move()\">  Apagar</button>\n            </div>\n        </div>\n    </div>\n</div>\n\n");
            DefineSection("Scripts", async() => {
                WriteLiteral("\n    <script type=\"text/javascript\">\n        let Cod_Comum = ");
#nullable restore
#line 85 "/home/ricksam/Projects/CCB/gem/Views/Usuario/Index.cshtml"
                    Write(DefaultComum);
...
#nullable disable
                WriteLiteral(";\n        let Tipo = \"");
#nullable restore
#line 86 "/home/ricksam/Projects/CCB/gem/Views/Usuario/Index.cshtml"
                Write(ViewBag.q);
...
#nullable disable
        ...
        function Lista() {
            rsp.get(null, ""/Usuario/List?Cod_Comum="" + Cod_Comum+""&q=""+Tipo, (res) => {
                ...
                $(""#ListaUsuarios .table"").DataTable({
                    ...
                    buttons: [
                        ...
                        { 
                            ...
                            text: '',
                            me");
                WriteLiteral(@"ssageTop: $(""#Congregacao"").html(),
                            exportOptions: {
                                columns: [ 0, 1, 2, 3, 4 ]
                            } 
                        }
                ...
                setTimeout(()=>{
                    $(""#DataTables_Table_0_wrapper .col-sm-12"").css(""over");
        ...
        function EnviarConvite(Email) {
            rsp.post({ Email }, ""/Home/EnviarConvite"", (res) => {
                if (res == ""ok"") {
                    ...
                    $(""#modalEdit .alert"").html(""Email enviado com suc");
                WriteLiteral(@"esso!"");
                    $(""#modalEdit .alert"").show();
                    $(""#btn_convite"").hide();
                } else {
