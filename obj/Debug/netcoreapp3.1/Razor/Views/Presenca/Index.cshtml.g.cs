#pragma checksum "/home/ricksam/Projects/CCB/gem/Views/Presenca/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c1518653cfe2b73f87614f7ce9f486b3dd79d029"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c1518653cfe2b73f87614f7ce9f486b3dd79d029", @"/Views/Presenca/Index.cshtml")]
...
#nullable disable
        ...
        function Lista() {
            rsp.get(null, ""/Presenca/List?Cod_Comum=""+Cod_Comum+""&FiltroPresenca=""+Filtro_Presenca+""&FiltroUsuario=""+Filtro_Usuario+""&Data=""+Data, (res) => {
        ...
        function Aula(Cod_Presenca) {
          ...
          function AdicionaAula(Cod_Presenca){
            ...
            function RemoveAula(Cod_Presenca, Cod_Estudo){
                rs");
                WriteLiteral(@"p.post({Cod_Estudo}, ""/Presenca/RemoveAula"", (res)=>{
                if(res==""ok""){
                    $(""#modalAula .alert"").hide();
                    Aula(Cod_Presenca);
                }
