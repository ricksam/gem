#pragma checksum "/home/ricksam/Projects/CCB/gem/Views/Presenca/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fca9d33dc477e9efb75eef4790721e6b9a1aeffc"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fca9d33dc477e9efb75eef4790721e6b9a1aeffc", @"/Views/Presenca/Index.cshtml")]
        ...
        function Filtro(){
            ...
            if((Filtro_Presenca.length==0||Filtro_Presenca==""Todos"")&&(Filtro_Usuario.length==0||Filtro_Usuario==""Todos"")){
                ...
                $("".tr_usuario"").each((index, element)=>{
                    if(Filtro_Presenca.length==0||Filtro_Presenca==""Todos""){
                        if((Filtro_Usuario==""Instrutores"" && $(el");
                WriteLiteral(@"ement).hasClass(""tr_instrutor""))
                        ...
                        if(
                            ...
                            ||(Filtro_Usuario==""Alunos"" ");
                WriteLiteral(@"&& $(element).hasClass(""tr_aluno"")&&Filtro_Presenca==""Presente"" && $(element).hasClass(""tr_presente""))
        ...
        function Aula(Cod_Presenca) {
          ...
          function AdicionaAula(Cod_Presenca){
            ...
            function RemoveAula(Cod_Presenca, Cod_Estudo){
                rsp.post({Cod_Estu");
                WriteLiteral(@"do}, ""/Presenca/RemoveAula"", (res)=>{
                if(res==""ok""){
                    $(""#modalAula .alert"").hide();
                    Aula(Cod_Presenca);
                }
