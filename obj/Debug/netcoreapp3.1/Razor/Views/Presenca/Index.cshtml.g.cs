#pragma checksum "d:\PROJECTS\RckSoftware\CCB\gem\Views\Presenca\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a6aae47084b023c1dab422294e3dd313d7c56e9f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a6aae47084b023c1dab422294e3dd313d7c56e9f", @"/Views/Presenca/Index.cshtml")]
...
<div class=""modal fade"" id=""modalHistorico"" tabindex=""-1"" role=""dialog"" aria-hidden=""true""  data-backdrop");
            WriteLiteral(@"=""static"">
    <div class=""modal-dialog modal-lg"" role=""document"">
        <div class=""modal-content"">
            <div class=""modal-header"">
    ...
    <div class=""modal-dialog modal-lg"" role=""document"">
        <div class=""modal-content"">
            <div class=""modal-header"">
                ...
                <button type=""b");
            WriteLiteral(@"utton"" class=""close"" data-dismiss=""modal"" aria-label=""Fechar"">
                    <span aria-hidden=""true"">&times;</span>
                </button>
            </div>
...
#nullable restore
#line 99 "d:\PROJECTS\RckSoftware\CCB\gem\Views\Presenca\Index.cshtml"
                    Write(DefaultComum);
...
#nullable disable
                WriteLiteral(";\r\n        let Cod_Grupo = 0;\r\n        let Data = \'");
#nullable restore
#line 101 "d:\PROJECTS\RckSoftware\CCB\gem\Views\Presenca\Index.cshtml"
...
#nullable disable
        ...
        function Filtro(){
            ...
            if(Filtro_Presenca.length==0||Filtro_Presenca==""T");
                WriteLiteral(@"odos""){
            ...
            if((Filtro_Presenca.length==0||Filtro_Presenca==""Todos"")&&(Filtro_Usuario.length==0||Filtro_Usuario==""Todos"")){
                ...
                $("".tr_usuario"").each((index, element)=>{
                    if(Filtro_Presenca.length==0||Filtro_Presenca==""Todos""){
                        ...
                        if(
                            (Filtro_Usuario==""Instrutores"" && $(element).hasClass(""tr_ins");
                WriteLiteral(@"trutor"")&&Filtro_Presenca==""Presente"" && $(element).hasClass(""tr_presente""))
 ...
 ");
                ...
                WriteLiteral(@"/Portuguese-Brasil.json""
                    }
                });
                setTimeout(()=>{
        ...
        function Aula(Cod_Presenca, Cod_Usuario, Aluno, Instrumento) {
            rsp.post({Cod_Presenca, Cod_Usuario, Aluno, Instrumento}, ""/Presenca/Aula"", (res) => {
                $(""#Aula"").html(res);
        ...
        function RemoveAula(Cod_Presenca, Cod_Usuario, Cod_Estudo){
            ...
            if(res==""ok""){
                $(""#modalAula .alert"").hide();
               ");
                WriteLiteral(@" Aula(Cod_Presenca, Cod_Usuario);
            }
            else{
                $(""#modalAula .alert"").html(res);
                $(""#modalAula .alert"").show();
        ...
        function Justificar() {
            rsp.post(""#Justificativa"", ""/Presenca/Justificar"", (res) => {
                if (res == ""ok"") {
                    ...
                    Lista();
                    showAlert(""Falta Justificad");
                WriteLiteral("a com sucesso!\", \"alert-success\");\r\n                } else {\r\n                    $(\"#modalJustificativa .alert\").html(res);\r\n                    $(\"#modalJustificativa .alert\").show();\r\n                }\r\n            })\r\n        }\r\n    </script>\r\n");
            }
            );
            WriteLiteral("\r\n\r\n");
        }
